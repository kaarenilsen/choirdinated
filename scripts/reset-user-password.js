...
/**
 * Script to reset a user's password in Supabase Auth
...
const envPath = join(__dirname, '../web-admin/.env.local')
...
async function main() {
  ...
  if (args.length !== 2) {
    console.log('📋 Usage: node scripts/reset-user-password.js <user-id> <new-password>')
    console.log('')
    console.log('Examples:')
    console.log('  node scripts/reset-user-password.js 123e4567-e89b-12d3-a456-426614174000 newpassword123')
