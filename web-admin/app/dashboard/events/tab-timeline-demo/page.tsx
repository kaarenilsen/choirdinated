import { TabTimeline } from '@/components/events/TabTimeline'
...
export default function TabTimelineDemoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Fanebasert Tidslinje Demo</h1>
        <p className="text-gray-600">
          Ukenavigering med faner øverst. Hver uke vises i detalj med tidslinje og 
          omfattende statistikk. Oversikt i fanene med oppmøteprosent.
        </p>
      </div>
      
      <TabTimeline weeks={demoWeeks} />
    </div>
  )
}