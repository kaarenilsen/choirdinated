import { CardTimeline } from '@/components/events/CardTimeline'
...
export default function CardTimelineDemoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Kortbasert Tidslinje Demo</h1>
        <p className="text-gray-600">
          Grid-layout med tilpassede kort og badges. Fargekodede arrangementtyper og 
          gradienter for oppmøteprosent. Trendikoner viser oppmøtestatus.
        </p>
      </div>
      
      <CardTimeline weeks={demoWeeks} />
    </div>
  )
}