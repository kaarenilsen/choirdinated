import { InteractiveTimeline } from '@/components/events/InteractiveTimeline'
...
export default function TimelineDemoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Interaktiv Tidslinje Demo</h1>
        <p className="text-gray-600">
          Hold musepekeren over arrangementer for å se mer informasjon. 
          Progresjonslinjene viser oppmøteprosent med farger som indikerer status.
        </p>
      </div>
      
      <InteractiveTimeline weeks={demoWeeks} />
    </div>
  )
}