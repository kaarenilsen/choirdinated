import { AccordionTimeline } from '@/components/events/AccordionTimeline'
...
export default function AccordionTimelineDemoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Trekkspill Tidslinje Demo</h1>
        <p className="text-gray-600">
          Sammenleggbar tidslinje med ukevisning. Klikk på ukene for å utvide og se arrangementer.
          Viser oppsummert statistikk når sammenlagt.
        </p>
      </div>
      
      <AccordionTimeline weeks={demoWeeks} />
    </div>
  )
}