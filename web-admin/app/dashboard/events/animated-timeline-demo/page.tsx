import { AnimatedTimeline } from '@/components/events/AnimatedTimeline'
...
export default function AnimatedTimelineDemoPage() {
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-2">Animert Tidslinje Demo</h1>
        <p className="text-gray-600">
          Tidslinje med Framer Motion animasjoner. Kort glir inn fra vekslende sider med forsinkede animasjoner.
          Linjen tegner seg selv og oppmøteprosenten animeres inn.
        </p>
      </div>
      
      <AnimatedTimeline weeks={demoWeeks} />
    </div>
  )
}